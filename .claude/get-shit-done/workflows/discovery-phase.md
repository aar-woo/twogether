...
See /Users/aaronwoo/claude/twogether/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /Users/aaronwoo/claude/twogether/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /Users/aaronwoo/claude/twogether/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /Users/aaronwoo/claude/twogether/.claude/get-shit-done/templates/discovery.md
...
Use /Users/aaronwoo/claude/twogether/.claude/get-shit-done/templates/discovery.md.
