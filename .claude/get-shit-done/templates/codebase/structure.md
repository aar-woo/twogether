...
- Usage: Reference from command with `@/Users/aaronwoo/claude/twogether/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/aaronwoo/claude/twogether/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/aaronwoo/claude/twogether/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
